...
public class SliderImageAdapter extends SliderViewAdapter<SliderImageAdapter.SliderAdapterVH>
{
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position)
    {
        ...
        Log.d(Codes.APP_TAGS, "banner ID " + bannerItem.getBannerId());
        Log.d(Codes.APP_TAGS, "banner image " + bannerItem.getBannerImage());
        //BannerData bannerItem = bannerItemList.get(position);
        ...
        for (int i =0; i <mCount; i++)
        {
            ...
            Glide.with(viewHolder.itemView).load(bannerItem.getBannerImage()).fitCenter().into(viewHolder.imageViewBackground);
        }
